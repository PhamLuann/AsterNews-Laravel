<div class="lg:block lg:col-span-1">
    <div class="sticky top-4">
        <div class="w-full pr-4 h-[35px] mt-4">
        ...
        <!-- end user -->
        <!-- location -->
        <div class="hidden lg:block bg-white rounded p-4 mt-10 relative">
            <div class="flex mb-2">
        ...
        <div class="hidden lg:block bg-white rounded p-4 mt-4 relative">
            <div class="flex items-center mb-2">
                ...
                <div class="flex absolute right-3">
                    ...
                    <div
                        class="w-6 h-6 bg-skyblue rounded-full flex items-center justify-center hover:cursor-pointer ml-2">
                        <img
